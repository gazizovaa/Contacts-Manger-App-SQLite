...
import com.example.contactsmangerappsqlite.MainActivity;
import com.example.contactsmangerappsqlite.R;
...
public class ContactsAdapter extends RecyclerView.Adapter<ContactsAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView){
            ...
            this.phoneNumb = itemView.findViewById(R.id.phoneNumb);
        }
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder,@SuppressLint("RecyclerView") int positions) {
        ...
        holder.phoneNumb.setText(contact.getPhoneNumb());
